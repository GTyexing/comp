...
class UnsolveClozeCon extends Component {
  static propTypes = {
      ...
      >
        ...
        >
          <div>
            错误答案
            {' '}
            {this.props.wrongAnswer.slice(0, this.props.wrongAnswer.length - 2)}
          </div>
          <Button
          ...
          >
            {this.state.isAddedInPaper ? '取消操作' : '不再显示'}
          </Button>
        </div>
      </div>
    );
...
export default UnsolveClozeCon;
